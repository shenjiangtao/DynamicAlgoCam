# mips64_loongson Platform Configuration
# Loongson (龙芯) MIPS64 platform

message(STATUS "Platform: mips64_loongson (Loongson)")

# Compiler flags for Loongson 3A5000/3C5000
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=loongarch64 -mtune=la464")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=loongarch64 -mtune=la464")

# Enable LoongArch features
add_compile_definitions(
    DYNALGO_PLATFORM_MIPS64_LOONGSON=1
    DYNALGO_HAVE_LASX=1
    DYNALGO_HAVE_LSX=1
)
...
# Loongson specific libraries
find_library(LOONGSON_VENC_LIB loongson_venc)
find_library(LOONGSON_NPU_LIB loongson_npu)
find_library(LOONGSON_ISP_LIB loongson_isp)
...
add_compile_definitions(
    DYNALGO_PLATFORM_NAME="mips64_loongson"
    DYNALGO_VENDOR_DEFAULT="loongson"
)