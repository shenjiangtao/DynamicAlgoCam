...
//
// dynalgo_color_convert.hpp — Color conversion utilities: MJPEG decoding,
...
//
// decodeColorToRGB(): converts any supported DynalgoFormat frame to RGB24.
...
struct MjpgDecoderRes
{
    ...
    bool init(int w, int h, DynalgoFormat fmt);
};
