...
inline NioFormat obFormatToNio(OBFormat f) {
    ...
    case OB_FORMAT_Y8:
        return NioFormat::Y8;
    case OB_FORMAT_Y16:
        return NioFormat::Y16;
    case OB_FORMAT_YUYV:
        return NioFormat::YUYV;
    case OB_FORMAT_YUY2:
        return NioFormat::YUY2;
    case OB_FORMAT_UYVY:
        return NioFormat::UYVY;
    case OB_FORMAT_MJPG:
        return NioFormat::MJPG;
    case OB_FORMAT_NV12:
        return NioFormat::NV12;
    case OB_FORMAT_NV21:
        return NioFormat::NV21;
    case OB_FORMAT_I420:
        return NioFormat::I420;
    case OB_FORMAT_RGB:
        return NioFormat::RGB;
    case OB_FORMAT_BGR:
        return NioFormat::BGR;
    case OB_FORMAT_RGBA:
        return NioFormat::RGBA;
    case OB_FORMAT_BGRA:
        return NioFormat::BGRA;
    case OB_FORMAT_H264:
        return NioFormat::H264;
    case OB_FORMAT_H265:
        return NioFormat::H265;
    case OB_FORMAT_HEVC:
        return NioFormat::HEVC;
    case OB_FORMAT_POINT:
        return NioFormat::POINT;
    default:
...
inline NioFrameType obFrameTypeToNio(OBFrameType t) {
    switch (t) {
    case OB_FRAME_COLOR:
        return NioFrameType::COLOR;
    case OB_FRAME_DEPTH:
        return NioFrameType::DEPTH;
    case OB_FRAME_IR:
        return NioFrameType::IR;
    case OB_FRAME_IR_LEFT:
        return NioFrameType::IR_LEFT;
    case OB_FRAME_IR_RIGHT:
        return NioFrameType::IR_RIGHT;
    case OB_FRAME_ACCEL:
        return NioFrameType::ACCEL;
    case OB_FRAME_GYRO:
        return NioFrameType::GYRO;
    case OB_FRAME_COLOR_LEFT:
        return NioFrameType::COLOR_LEFT;
    case OB_FRAME_COLOR_RIGHT:
        return NioFrameType::COLOR_RIGHT;
    case OB_FRAME_CONFIDENCE:
        return NioFrameType::CONFIDENCE;
    case OB_FRAME_POINTS:
        return NioFrameType::POINT;
    default:
        return NioFrameType::COLOR;
    }
}
