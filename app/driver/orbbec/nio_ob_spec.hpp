...
//
// nio_ob_spec.hpp - Orbbec device specifications and configuration constants.
//
...
inline constexpr NioFormat COLOR_FMT_DEFAULT = NioFormat::MJPG;
inline constexpr NioFormat COLOR_FMT_GEMINI305 = NioFormat::YUYV;
inline constexpr NioFormat COLOR_FMT_GEMINI335L336L = NioFormat::YUYV;
 ...
 * @return The preferred NioFormat for the color stream.
 */
[[nodiscard]] constexpr NioFormat getPreferredColorFormat(bool isGemini305, bool isGemini335L336L) {
