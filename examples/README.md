...
| stream   | [confidence](1.stream.confidence)                       | Use the SDK interface to obtain the depth and confidence stream of the camera and display them in the window.                                                                                                      |
...
| stream   | [decimation](1.stream.decimation)                         | Use the SDK interface to configure device preset resolutions, select decimation profiles for sensors, and display them in the window. |                                                                                                                                               |
...
| device   | [device_forceip](2.device.forceip)                      | This example shows how to configure a new IP for an network device using the ForceIP command.                                                                      |
