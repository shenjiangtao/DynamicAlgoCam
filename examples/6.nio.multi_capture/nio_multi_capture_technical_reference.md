...
> 基于源码 `examples/6.nio.multi_capture/nio_multi_capture.cpp` (1080行) 及其工具库实现分析。
...
> 文件：`examples/6.nio.multi_capture/parse_depth_raw.py`
...
> 文件：`examples/6.nio.multi_capture/colorize_from_video.py`
...
> 文件：`examples/6.nio.multi_capture/colorize_from_video.sh`
...
> 文件：`examples/6.nio.multi_capture/batch_wrap_color_depth.sh`
