...
class BoltPresetManager : public IPresetManager, public DeviceComponentBase {
public:
    BoltPresetManager(IDevice *owner);
    ~BoltPresetManager() override = default;
...
private:
    ...
    void        loadCustomPreset(const std::string &presetName, const BoltPreset &preset);
...
private:
    ...
    std::map<std::string, BoltPreset> customPresets_;
};
