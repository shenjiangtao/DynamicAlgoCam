...
const std::map<uint32_t, OBPropertyBaseInfo> OBPropertyBaseInfoMap = {
    ...
    PROP_INFO_PAIR(OB_PROP_FEMTO_MEGA_HARDWARE_D2C_BOOL, OB_BOOL_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_DEPTH_OUTLIERS_FILTER_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEPTH_OUTLIERS_FILTER_SEARCH_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEVICE_RESET_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LDP_STATUS_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_STOP_DEPTH_STREAM_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_STOP_IR_STREAM_BOOL, OB_BOOL_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_TOF_EXPOSURE_TIME_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_REBOOT_DEVICE_BOOL, OB_BOOL_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_STOP_COLOR_STREAM_BOOL, OB_BOOL_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_DISP_SEARCH_OFFSET_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CPU_TEMPERATURE_CALIBRATION_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_START_IR_RIGHT_STREAM_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_FRAME_INTERLEAVE_CONFIG_INDEX_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_FRAME_INTERLEAVE_ENABLE_BOOL, OB_BOOL_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_ON_CHIP_CALIBRATION_ENABLE_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_HW_NOISE_REMOVE_FILTER_ENABLE_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_HW_NOISE_REMOVE_FILTER_THRESHOLD_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_DEVICE_AUTO_CAPTURE_ENABLE_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_DEVICE_AUTO_CAPTURE_INTERVAL_TIME_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_DEVICE_PTP_CLOCK_SYNC_ENABLE_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_INTRA_CAMERA_SYNC_REFERENCE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_ROI_BRIGHTNESS_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COMPAT_VERSION_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_RIGHT_ROTATE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_RIGHT_MIRROR_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_RIGHT_FLIP_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_LEFT_ROTATE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_LEFT_MIRROR_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_LEFT_FLIP_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEVICE_AE_REFERENCE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEVICE_AE_STRATEGY_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEVICE_NETWORK_LLA_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_ANTI_FLICKER_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEVICE_IP_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DHCP_ASSIGN_IP_TIMEOUT_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CURRENT_DISP_SEARCH_RANGE_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CURRENT_DISP_SEARCH_OFFSET_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_FPS_BOOST_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_MJPEG_QUALITY_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_HOST_PLATFORM_INT, OB_INT_PROPERTY),
    // 1000 - 2000
    ...
    PROP_INFO_PAIR(OB_STRUCT_DISP_OFFSET_CONFIG, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_IR_RIGHT_STREAM_PROFILE, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_SOFTWARE_SYNCED_TARGET_TIME, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_COLOR_SYNCED_EXPOSURE_PARAM, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_DEVICE_IP_ADDR_CONFIG_V2, OB_STRUCT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_COLOR_PRESET_PRIORITY_INT, OB_INT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_COLOR_AE_MAX_GAIN_INT, OB_INT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_DEPTH_AUTO_EXPOSURE_PRIORITY_INT, OB_INT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_DEPTH_INDUSTRY_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_IMU_STREAM_PORT_INT, OB_INT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_USB_SYNC_VOLTAGE_LEVEL_INT, OB_INT_PROPERTY),
    ...
    // 4000 - 5000
    PROP_INFO_PAIR(OB_RAW_DATA_D2C_ALIGN_SUPPORT_PROFILE_LIST, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_DEPTH_CALIB_PARAM, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_ALIGN_CALIB_PARAM, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_CAMERA_CALIB_JSON_FILE, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_STREAM_PROFILE_LIST, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_DEPTH_ALG_MODE_LIST, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_IMU_CALIB_PARAM, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_DEVICE_EXTENSION_INFORMATION, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_PRESET_RESOLUTION_MASK_LIST, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_DEPTH_POST_FILTER_PARAMS, OB_STRUCT_PROPERTY),

    // PROP_INFO_PAIR(OB_STRUCT_LDP_MEASURE_EXTENSION_INFO, OB_STRUCT_PROPERTY),

    // 5000 - 6000
    PROP_INFO_PAIR(OB_PROP_DEBUG_ESGM_CONFIDENCE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_DEPTH_WITH_CONFIDENCE_STREAM_ENABLE_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CONFIDENCE_STREAM_FILTER_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CONFIDENCE_STREAM_FILTER_THRESHOLD_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CONFIDENCE_MIRROR_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CONFIDENCE_FLIP_BOOL, OB_BOOL_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_CONFIDENCE_ROTATE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_PRESET_RESOLUTION_CONFIG_LIST, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_PRESET_RESOLUTION_CONFIG, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_DEVICE_ERROR_STATE, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_COLOR_DENOISING_LEVEL_INT, OB_INT_PROPERTY),

    // LiDAR
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_IP_ADDRESS, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_PORT_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_MAC_ADDRESS, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_SUBNET_MASK, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_SCAN_SPEED_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_SCAN_DIRECTION_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_TRANSFER_PROTOCOL_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_WORK_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_APPLY_CONFIGS_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_TAIL_FILTER_LEVEL_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_MEMS_FOV_SIZE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_MEMS_FRENQUENCY_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_MEMS_FOV_FACTOR_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_MEMS_ON_OFF_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_RESTART_MEMS_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_PRODUCT_MODEL, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_FIRMWARE_VERSION, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_FPGA_VERSION, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_LIDAR_STATUS_INFO, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_WARNING_INFO_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_MOTOR_SPIN_SPEED_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_MCU_TEMPERATURE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_FPGA_TEMPERATURE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_MOTOR_VERSION, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_APD_HIGH_VOLTAGE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_APD_TEMPERATURE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_TX_HIGH_POWER_VOLTAGE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_TX_LOWER_POWER_VOLTAGE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_MEMS_VERSION, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_SPECIFIC_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_REPETITIVE_SCAN_MODE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_STREAMING_ON_OFF_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_IMU_FRAME_RATE_INT, OB_INT_PROPERTY),
    PROP_INFO_PAIR(OB_STRUCT_LIDAR_IMU_FULL_SCALE_RANGE, OB_STRUCT_PROPERTY),
