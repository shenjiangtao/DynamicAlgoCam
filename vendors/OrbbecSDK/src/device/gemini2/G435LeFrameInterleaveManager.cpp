...
G435LeFrameInterleaveManager::G435LeFrameInterleaveManager(IDevice *owner) : DeviceComponentBase(owner) {
...
void G435LeFrameInterleaveManager::loadFrameInterleave(const std::string &frameInterleaveName) {
...
const std::vector<std::string> &G435LeFrameInterleaveManager::getAvailableFrameInterleaveList() const {
    return availableFrameInterleaves_;
}

void G435LeFrameInterleaveManager::updateFrameInterleaveParam(uint32_t propertyId) {
    auto owner = getOwner();
