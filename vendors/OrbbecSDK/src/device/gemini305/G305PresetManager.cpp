...
const std::string &G305PresetManager::getCurrentPresetName() const {
...
void G305PresetManager::loadPresetFromJsonData(const std::string &presetName, const std::vector<uint8_t> &jsonData) {
    Json::Value  root;
    Json::Reader reader;
...
void G305PresetManager::loadPresetFromJsonFile(const std::string &filePath) {
    Json::Value   root;
...
Json::Value G305PresetManager::exportSettingsAsPresetJsonValue(const std::string &presetName) {
...
void G305PresetManager::exportSettingsAsPresetJsonFile(const std::string &filePath) {
...
void G305PresetManager::loadCustomPreset(const std::string &presetName, const G305Preset &preset) {
...
void G305PresetManager::storeCurrentParamsAsCustomPreset(const std::string &presetName) {
    G305Preset preset{};
    auto       owner = getOwner();
