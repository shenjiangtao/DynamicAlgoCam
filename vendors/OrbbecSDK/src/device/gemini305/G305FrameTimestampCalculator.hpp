...
class G305FrameTimestampCalculatorBaseDeviceTime : public IFrameTimestampCalculator {
public:
    G305FrameTimestampCalculatorBaseDeviceTime(IDevice *device, uint64_t deviceTimeFreq, uint64_t frameTimeFreq);

    virtual ~G305FrameTimestampCalculatorBaseDeviceTime() noexcept override = default;
