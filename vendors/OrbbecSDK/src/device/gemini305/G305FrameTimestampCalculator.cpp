...
G305FrameTimestampCalculatorBaseDeviceTime::G305FrameTimestampCalculatorBaseDeviceTime(IDevice *device, uint64_t deviceTimeFreq, uint64_t frameTimeFreq)
...
void G305FrameTimestampCalculatorBaseDeviceTime::calculate(std::shared_ptr<Frame> frame) {
